...
const SharedMapPage: React.FC = () => {
  ...
  const addOrUpdateVessel = useCallback(
  ...
  return (
    <div className="relative flex w-full flex-1">
      ...
      <div
        id="coordinates"
        className="absolute bottom-2.5 left-1/2 z-[999] -translate-x-1/2 rounded-md bg-slate-800 bg-opacity-70 px-3 py-1 text-xs text-white shadow-lg"
      >
        {coordinates}
      </div>
