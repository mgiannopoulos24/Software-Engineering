...
const MapComponent = forwardRef<MapComponentRef, MapComponentProps>(
    ({
         vessels, selectedVessel, onMapReady, onVesselClick,
         trackData, currentTrackMmsi, onShowTrackRequest, onHideTrackRequest, isTrackLoading,
         isShipInFleet, onAddToFleet, onRemoveFromFleet, isAuthenticated
     }, ref) => {
        ...
        useEffect(() => {
            ...
            const popupContent = createPopupHtml(selectedVessel, isTrackShown, isLoadingThisTrack, isBookmarked, isAuthenticated);
            ...
            const setupPopupButtons = () => {
                ...
                if (showBtn) L.DomEvent.on(showBtn, 'click', (e) => { L.DomEvent.stop(e); onShowTrackRequest(selectedVessel.mmsi); });
        ...
        }, [selectedVessel, trackData, currentTrackMmsi, isTrackLoading, onShowTrackRequest, onHideTrackRequest, isShipInFleet, onAddToFleet, onRemoveFromFleet, isAuthenticated]);
